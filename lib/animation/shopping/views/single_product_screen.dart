import 'package:flutkit/animation/shopping/controllers/single_product_controller.dart';
        ...
        children: [
          Hero(
            ...
            child: MyContainer(
              ...
              child: Image(
                fit: BoxFit.cover,
                image: NetworkImage(controller.product.imageUrls),
              ),
            ),
          ),
          MySpacing.height(20),
              ...
              children: [
                ...
                Expanded(
                  child: MyButton.block(
                    ...
                    // },
                    onPressed: () {
                      // Toggle cart animation based on the addCart state
                      controller.addCart
                          ? controller.cartController.reverse()
                          : controller.cartController.forward();

                      // Call addToCart to handle API request
